...
public class SinglePlayerResource {
  ...
  @Operation(summary = "Initialize Player", description = "Initializes a new player record in the database.", responses = {
  ...
  @Operation(summary = "Set Player Online Status", description = "Updates a player's online status in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Jobs", description = "Updates a player's main and sub jobs in the database.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Gil", description = "Updates a player's gil amount in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Engagement Status", description = "Updates a player's engagement status in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player HP Percentage", description = "Updates a player's HP percentage in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player MP Percentage", description = "Updates a player's MP percentage in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player TP", description = "Updates a player's TP (Tactical Points) in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Zone", description = "Updates a player's current zone in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Merits", description = "Updates a player's merit points (total and max) in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Capacity Points", description = "Updates a player's capacity points in the database and broadcasts the update via WebSocket.", responses = {
  ...
  public Response setCapacityPoints(SetCapacityPointsRequest request) {
    try {
      LOG.info("Received set_capacity_points request: {}", request);
      if (request == null || request.getPlayerId() == null ||
          request.getPlayerName() == null || request.getNumberOfJobPoints() == null) {
        return Response.status(Response.Status.BAD_REQUEST)
            .entity("playerId, playerName, and numberOfJobPoints are required")
            .build();
      }
      ...
      capacityPointsDoc.put("total", request.getNumberOfJobPoints());
      ...
      capacityPointsData.put("total", request.getNumberOfJobPoints());
      broadcastData.put("capacityPoints", capacityPointsData);

      PlayerWebSocket.broadcast(broadcastData);

      LOG.info("Updated capacity points for player {} ({}): total={}",
          request.getPlayerId(), playerName, request.getNumberOfJobPoints());
  ...
  @Path("/get_buffs")
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(summary = "Get Player Buffs", description = "Retrieves a player's current buffs from the database by playerId.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Buffs", description = "Updates a player's buffs in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Path("/get_chat_log")
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(summary = "Get Player Chat Log", description = "Retrieves a player's chat log from the database by playerId.", responses = {
  ...
  @Produces(MediaType.APPLICATION_JSON)
  @Operation(summary = "Get Player Chat Log by Type", description = "Retrieves a player's chat log filtered by message type from the database by playerId.", responses = {
  ...
  public Response getChatLogByType(
    ...
    try {
      ...
      // Node.js stores chatLog as a map keyed by messageType string (e.g.
      // chatLog["1"][]).
      ...
      if (chatLogRaw instanceof Document) {
        ...
        if (typeEntries instanceof List<?>) {
          for (Object item : (List<?>) typeEntries) {
            if (item instanceof Document)
              filteredChatLog.add((Document) item);
          }
        }
      } else {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Messages", description = "Updates a player's messages in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Refresh Player Buffs", description = "Refreshes (clears) a player's buffs in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Reset Player Experience History", description = "Resets a player's experience history by clearing all exp types to empty arrays in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Currency1", description = "Updates a player's currency1 values in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Currency2", description = "Updates a player's currency2 values in the database and broadcasts the update via WebSocket.", responses = {
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Stats", description = "Updates a player's stats (both root-level fields and nested stats object) in the database and broadcasts the update via WebSocket.", responses = {
  ...
  public Response setStats(SetStatsRequest request) {
    try {
      ...
      LOG.info(
          "Request details: playerName={}, masterLevel={}, mainJobLevel={}, subJobLevel={}, attack={}, defense={}, title={}, nationRank={}, currentExemplar={}, requiredExemplar={}",
          request != null ? request.getPlayerName() : "null",
  ...
  @Consumes(MediaType.APPLICATION_JSON)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(summary = "Set Player Experience History", description = "Updates a player's experience history in the database and broadcasts the update via WebSocket. Maintains a maximum of 50 entries per exp type.", responses = {
